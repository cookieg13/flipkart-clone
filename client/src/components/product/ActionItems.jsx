...
const ActionItems = ({ product }) => {
    ...
    /*     const buyNow = async () => {
            let response = await payUsingPaytm( { amount: 500, email: 'pixiedust001dg@gmail.com'});
    ...
    return (
        <Box className={classes.leftContainer}>
            ...
            <Button onClick={() => addItemToCart()} variant="contained" className={clsx(classes.button, classes.addToCart)}><Cart />
                Add to Cart</Button>
